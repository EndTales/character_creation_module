...
def attack(char_name: str, char_class: str) -> str:
    """Показывает урон персонажа в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Показывает защиту персонажа в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Показывает специальные умения персонажа в зависимости от класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор класса персонажа возвращает класс."""
    approve_choice: str = ''
    char_class: str = ''
